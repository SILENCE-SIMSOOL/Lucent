...
커스텀 HUD 요소를 정의하려면 [LucentHUD](file:///d:/FROZEN/Dev%20Mod/Mod-Build/%21Fabric/Projects/Lucent/src/main/java/silence/simsool/lucent/general/models/abstracts/LucentHUD.java) 클래스를 상속받는 클래스를 생성해야 합니다.

실제 내장 예제 코드인 [ExampleHUD.java](file:///d:/FROZEN/Dev%20Mod/Mod-Build/%21Fabric/Projects/Lucent/src/main/java/silence/simsool/lucent/examplemod/huds/ExampleHUD.java) 파일의 구조를 참고하여 쉽고 완성도 높게 구현할 수 있습니다.
