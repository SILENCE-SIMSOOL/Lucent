...
[ThemeManager](../../src/main/java/silence/simsool/lucent/ui/theme/ThemeManager.java) 클래스를 활용하여 테마를 검색하고 설정 화면에 적용할 수 있습니다.
...
```
테마가 변경되면 [UIColors](../../src/main/java/silence/simsool/lucent/ui/utils/UIColors.java)에 설정된 다이내믹 컬러 변수값들이 연동되어 실시간으로 자동 갱신됩니다.
