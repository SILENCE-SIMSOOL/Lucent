...
public final class GUIEvent {
	...
	public static class RenderContainer {
		...
		public RenderContainer(GuiGraphics graphics, Screen screen, int mouseX, int mouseY, int x, int y, int width, int height) {
			this.graphics = graphics;
			this.screen = screen;
			this.title = (screen != null && screen.getTitle() != null) ? UChat.getString(screen.getTitle()) : "";
			this.mouseX = mouseX;
	...
	public static class RenderChest {
		...
		public RenderChest(GuiGraphics graphics, Screen screen, int mouseX, int mouseY, int x, int y, int width, int height) {
			this.graphics = graphics;
			this.screen = screen;
			this.title = (screen != null && screen.getTitle() != null) ? UChat.getString(screen.getTitle()) : "";
			this.mouseX = mouseX;
	...
	public static class RenderInventory {
		...
		public RenderInventory(GuiGraphics graphics, Screen screen, int mouseX, int mouseY, int x, int y, int width, int height) {
			this.graphics = graphics;
			this.screen = screen;
			this.title = (screen != null && screen.getTitle() != null) ? UChat.getString(screen.getTitle()) : "";
			this.mouseX = mouseX;
	...
	public static class SlotClickEvent {
		...
		public SlotClickEvent(Slot slot, int slotId, int button, ClickType actionType, AbstractContainerMenu handler, AbstractContainerScreen<?> screen) {
			this.slot = slot;
			this.slotId = slotId;
			this.button = button;
	...
	public static class RenderSlotPreEvent {
		...
		public RenderSlotPreEvent(Slot slot, GuiGraphics graphics, AbstractContainerScreen<?> screen) {
			this.slot = slot;
			this.graphics = graphics;
			this.screen = screen;
			this.title = (screen != null && screen.getTitle() != null) ? UChat.getString(screen.getTitle()) : "";
	...
	public static class RenderSlotPostEvent {
		...
		public RenderSlotPostEvent(Slot slot, GuiGraphics graphics, AbstractContainerScreen<?> screen) {
			this.slot = slot;
			this.graphics = graphics;
			this.screen = screen;
			this.title = (screen != null && screen.getTitle() != null) ? UChat.getString(screen.getTitle()) : "";
	...
	public static class RenderHotbarPreEvent {
		...
		public RenderHotbarPreEvent(ItemStack itemStack, int x, int y, GuiGraphics graphics) {
	...
	public static class RenderHotbarPostEvent {
		...
		public RenderHotbarPostEvent(ItemStack itemStack, int x, int y, GuiGraphics graphics) {
			this.itemStack = itemStack;
			this.x = x;
			this.y = y;
			this.graphics = graphics;
