...
public class DrawContextRenderer {
	...
	public static void roundedFill(GuiGraphicsExtractor context, int x0, int y0, int x1, int y1, int color, RoundedOptions options) {
		submitRoundedRect(context, x0, y0, x1, y1, color, color, color, color, options);
	}

	public static void roundedFill(GuiGraphicsExtractor context, int x0, int y0, int x1, int y1, int color, float radius, int outlineColor, float outlineWidth) {
	...
	public static void roundedFill(GuiGraphicsExtractor context, int x0, int y0, int x1, int y1, int color, CornerRadii radii, int outlineColor, float outlineWidth) {
		roundedFill(context, x0, y0, x1, y1, color, new RoundedOptions(radii, outlineOrNull(outlineColor, outlineWidth)));
	}

	public static void roundedOutline(GuiGraphicsExtractor context, int x0, int y0, int x1, int y1, int outlineColor, float outlineWidth, CornerRadii radii) {
	...
	public static void roundedOutline(GuiGraphicsExtractor context, int x0, int y0, int x1, int y1, int outlineColor, float outlineWidth, float radius) {
		roundedOutline(context, x0, y0, x1, y1, outlineColor, outlineWidth, CornerRadii.uniform(radius));
	}

	public static void roundedFillGradient(GuiGraphicsExtractor context, int x0, int y0, int x1, int y1, int startColor, int endColor, GradientDirection direction, RoundedOptions options) {
