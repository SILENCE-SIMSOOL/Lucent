...
public class UText {
	...
	public static void drawText(GuiGraphics graphics, String text, float x, float y, float scale, boolean shadow) {
		drawText(graphics, text, x, y, scale, UIColors.PURE_WHITE, shadow);
	}

	public static void drawText(GuiGraphics graphics, String text, float x, float y, int color, boolean shadow) {
		drawText(graphics, text, x, y, 1.0f, color, shadow);
	}

	public static void drawText(GuiGraphics graphics, String text, float x, float y, boolean shadow) {
	...
	public static void drawShadowText(GuiGraphics graphics, String text, float x, float y) {
	...
	public static void drawTextRatio(GuiGraphics graphics, String text, float x, float y, float scale, float scaleRatio, boolean shadow) {
		drawText(graphics, text, x, y, scale, scaleRatio, UIColors.PURE_WHITE, shadow);
	}

	public static void drawTextRatio(GuiGraphics graphics, String text, float x, float y, float scaleRatio, int color, boolean shadow) {
		drawText(graphics, text, x, y, 1.0f, scaleRatio, color, shadow);
	}

	public static void drawTextRatio(GuiGraphics graphics, String text, float x, float y, float scaleRatio, boolean shadow) {
	...
	public static void drawTextRatio(GuiGraphics graphics, String text, float x, float y, float scaleRatio, int color) {
		drawText(graphics, text, x, y, 1.0f, scaleRatio, color, false);
	}

	public static void drawTextRatio(GuiGraphics graphics, String text, float x, float y, float scaleRatio) {
	...
	public static void drawShadowTextRatio(GuiGraphics graphics, String text, float x, float y, float scaleRatio, int color) {
		drawText(graphics, text, x, y, 1.0f, scaleRatio, color, true);
	}

	public static void drawShadowTextRatio(GuiGraphics graphics, String text, float x, float y, float scaleRatio) {
	...
	public static void drawCenteredText(GuiGraphics graphics, String text, float centerX, float y, float scale, boolean shadow) {
		drawCenteredText(graphics, text, centerX, y, scale, UIColors.PURE_WHITE, shadow);
	}

	public static void drawCenteredText(GuiGraphics graphics, String text, float centerX, float y, int color, boolean shadow) {
		drawCenteredText(graphics, text, centerX, y, 1.0f, color, shadow);
	}

	public static void drawCenteredText(GuiGraphics graphics, String text, float centerX, float y, boolean shadow) {
	...
	public static void drawCenteredText(GuiGraphics graphics, String text, float centerX, float y, int color) {
		drawCenteredText(graphics, text, centerX, y, 1.0f, color, false);
	}

	public static void drawCenteredText(GuiGraphics graphics, String text, float centerX, float y) {
	...
	public static void drawCenteredShadowText(GuiGraphics graphics, String text, float centerX, float y, int color) {
		drawCenteredText(graphics, text, centerX, y, 1.0f, color, true);
	}

	public static void drawCenteredShadowText(GuiGraphics graphics, String text, float centerX, float y) {
	...
	public static void drawTexts(GuiGraphics graphics, List<String> lines, float x, float y, float scale, float lineHeight, int color, boolean shadow) {
		float currentY = y;
	...
	public static void drawTexts(GuiGraphics graphics, List<String> lines, float x, float y, float scale, boolean shadow) {
		drawTexts(graphics, lines, x, y, scale, (mc.font.lineHeight + 2) * scale, UIColors.PURE_WHITE, shadow);
	}

	public static void drawTexts(GuiGraphics graphics, List<String> lines, float x, float y, int color, boolean shadow) {
		drawTexts(graphics, lines, x, y, 1.0f, (mc.font.lineHeight + 2), color, shadow);
	}

	public static void drawTexts(GuiGraphics graphics, List<String> lines, float x, float y, boolean shadow) {
		drawTexts(graphics, lines, x, y, 1.0f, (mc.font.lineHeight + 2), UIColors.PURE_WHITE, shadow);
	}

	public static void drawTexts(GuiGraphics graphics, List<String> lines, float x, float y, float scale, float lineHeight, boolean shadow) {
		drawTexts(graphics, lines, x, y, scale, lineHeight, UIColors.PURE_WHITE, shadow);
	}

	public static void drawTexts(GuiGraphics graphics, List<String> lines, float x, float y, float scale, int color, boolean shadow) {
		drawTexts(graphics, lines, x, y, scale, (mc.font.lineHeight + 2) * scale, color, shadow);
	}

	public static void drawTexts(GuiGraphics graphics, List<String> lines, float x, float y, float scale, int color) {
		drawTexts(graphics, lines, x, y, scale, color, false);
	}

	public static void drawTexts(GuiGraphics graphics, List<String> lines, float x, float y, float scale) {
		drawTexts(graphics, lines, x, y, scale, UIColors.PURE_WHITE, false);
	}

	public static void drawTexts(GuiGraphics graphics, List<String> lines, float x, float y, int color) {
		drawTexts(graphics, lines, x, y, 1.0f, color, false);
	}

	public static void drawTexts(GuiGraphics graphics, List<String> lines, float x, float y) {
	...
	public static void drawCenteredTexts(GuiGraphics graphics, List<String> lines, float centerX, float y, float scale, float lineHeight, int color, boolean shadow) {
		float currentY = y;
		for (String line : lines) {
	...
	public static void drawCenteredTexts(GuiGraphics graphics, List<String> lines, float centerX, float y, float scale, boolean shadow) {
		drawCenteredTexts(graphics, lines, centerX, y, scale, (mc.font.lineHeight + 2) * scale, UIColors.PURE_WHITE, shadow);
	}

	public static void drawCenteredTexts(GuiGraphics graphics, List<String> lines, float centerX, float y, int color, boolean shadow) {
		drawCenteredTexts(graphics, lines, centerX, y, 1.0f, (mc.font.lineHeight + 2), color, shadow);
	}

	public static void drawCenteredTexts(GuiGraphics graphics, List<String> lines, float centerX, float y, boolean shadow) {
		drawCenteredTexts(graphics, lines, centerX, y, 1.0f, (mc.font.lineHeight + 2), UIColors.PURE_WHITE, shadow);
	}

	public static void drawCenteredTexts(GuiGraphics graphics, List<String> lines, float centerX, float y, float scale, float lineHeight, boolean shadow) {
		drawCenteredTexts(graphics, lines, centerX, y, scale, lineHeight, UIColors.PURE_WHITE, shadow);
	}

	public static void drawCenteredTexts(GuiGraphics graphics, List<String> lines, float centerX, float y, float scale, int color, boolean shadow) {
		drawCenteredTexts(graphics, lines, centerX, y, scale, (mc.font.lineHeight + 2) * scale, color, shadow);
	}

	public static void drawCenteredTexts(GuiGraphics graphics, List<String> lines, float centerX, float y, float scale, int color) {
		drawCenteredTexts(graphics, lines, centerX, y, scale, color, false);
	}

	public static void drawCenteredTexts(GuiGraphics graphics, List<String> lines, float centerX, float y, float scale) {
		drawCenteredTexts(graphics, lines, centerX, y, scale, UIColors.PURE_WHITE, false);
	}

	public static void drawCenteredTexts(GuiGraphics graphics, List<String> lines, float centerX, float y, int color) {
		drawCenteredTexts(graphics, lines, centerX, y, 1.0f, color, false);
	}

	public static void drawCenteredTexts(GuiGraphics graphics, List<String> lines, float centerX, float y) {
	...
	public static void drawTextsRatio(GuiGraphics graphics, List<String> lines, float x, float y, float scale, float scaleRatio, float lineHeight, int color, boolean shadow) {
		float currentY = y;
		for (String line : lines) {
	...
	public static void drawTextsRatio(GuiGraphics graphics, List<String> lines, float x, float y, float scale, float scaleRatio, boolean shadow) {
		drawTextsRatio(graphics, lines, x, y, scale, scaleRatio, (mc.font.lineHeight + 2) * scale, UIColors.PURE_WHITE, shadow);
	}

	public static void drawTextsRatio(GuiGraphics graphics, List<String> lines, float x, float y, float scaleRatio, int color, boolean shadow) {
		drawTextsRatio(graphics, lines, x, y, 1.0f, scaleRatio, (mc.font.lineHeight + 2), color, shadow);
	}

	public static void drawTextsRatio(GuiGraphics graphics, List<String> lines, float x, float y, float scaleRatio, boolean shadow) {
		drawTextsRatio(graphics, lines, x, y, 1.0f, scaleRatio, (mc.font.lineHeight + 2), UIColors.PURE_WHITE, shadow);
	}

	public static void drawTextsRatio(GuiGraphics graphics, List<String> lines, float x, float y, float scale, float scaleRatio, float lineHeight, boolean shadow) {
		drawTextsRatio(graphics, lines, x, y, scale, scaleRatio, lineHeight, UIColors.PURE_WHITE, shadow);
	}

	public static void drawTextsRatio(GuiGraphics graphics, List<String> lines, float x, float y, float scale, float scaleRatio, int color, boolean shadow) {
		drawTextsRatio(graphics, lines, x, y, scale, scaleRatio, (mc.font.lineHeight + 2) * scale, color, shadow);
	}

	public static void drawTextsRatio(GuiGraphics graphics, List<String> lines, float x, float y, float scale, float scaleRatio, int color) {
		drawTextsRatio(graphics, lines, x, y, scale, scaleRatio, color, false);
	}

	public static void drawTextsRatio(GuiGraphics graphics, List<String> lines, float x, float y, float scale, float scaleRatio) {
		drawTextsRatio(graphics, lines, x, y, scale, scaleRatio, UIColors.PURE_WHITE, false);
	}

	public static void drawTextsRatio(GuiGraphics graphics, List<String> lines, float x, float y, float scaleRatio, int color) {
		drawTextsRatio(graphics, lines, x, y, 1.0f, scaleRatio, (mc.font.lineHeight + 2), color, false);
	}

	public static void drawTextsRatio(GuiGraphics graphics, List<String> lines, float x, float y, float scaleRatio) {
