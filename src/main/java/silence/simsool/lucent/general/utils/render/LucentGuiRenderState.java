...
public class LucentGuiRenderState implements GuiElementRenderState {
	...
	public LucentGuiRenderState(RenderPipeline pipeline, TextureSetup textureSetup, GuiGraphicsExtractor graphics, ScreenRectangle bounds, Consumer<VertexConsumer> vertexConsumerFunc) {
