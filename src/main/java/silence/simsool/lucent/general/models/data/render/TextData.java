...
public class TextData {
	...
	public TextData(String text, Vec3 pos, float scale, boolean depth, Quaternionf rotation, Font font, float width, int color, int backgroundColor, int outlineColor, boolean shadow) {
		set(text, pos, scale, depth, rotation, font, width, color, backgroundColor, outlineColor, shadow);
	}
	...
	public TextData(String text, Vec3 pos, float scale, boolean depth, Quaternionf rotation, Font font, float width, int color, int backgroundColor, int outlineColor) {
		set(text, pos, scale, depth, rotation, font, width, color, backgroundColor, outlineColor, true);
	}

	public void set(String text, Vec3 pos, float scale, boolean depth, Quaternionf rotation, Font font, float width, int color, int backgroundColor, int outlineColor, boolean shadow) {
		this.text = text;
		this.pos = pos;
		this.scale = scale;
		this.depth = depth;
