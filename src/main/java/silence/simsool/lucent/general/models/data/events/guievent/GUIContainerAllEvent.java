...
public class GUIContainerAllEvent {
	...
	public GUIContainerAllEvent(GuiGraphics graphics, Screen screen, int mouseX, int mouseY, int x, int y, int width, int height) {
