...
public class GUIContainerChestEvent {
	...
	public GUIContainerChestEvent(GuiGraphics graphics, Screen screen, int mouseX, int mouseY, int x, int y, int width, int height) {
