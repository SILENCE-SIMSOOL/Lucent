...
public class CFontRenderer {
	...
	/**
	 * 문자열을 그린다.
	 * @param ctx      GuiGraphicsExtractor 컨텍스트
	 ...
	 */
	public int drawString(GuiGraphicsExtractor ctx, String text, float x, float y, int color, boolean shadow, float size) {
	...
	private int renderString(GuiGraphicsExtractor ctx, String text, float startX, float startY, int color) {
		float posX = startX;
