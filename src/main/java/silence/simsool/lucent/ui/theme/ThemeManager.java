...
public class ThemeManager {
	...
	static {
		...
		AVAILABLE_THEMES.add(new LucentTheme("Midnight Cyan",
				0xE60A0C13, 0xE606080E, 0xFF00D2FF, 0xFFFFFFFF, 0xFFA5B4FC, 0xFF6B7280,
		...
		AVAILABLE_THEMES.add(new LucentTheme("Crimson Aurora",
				0xE61A0C0C, 0xE6120808, 0xFFF43F5E, 0xFFFFFFFF, 0xFFFDA4AF, 0xFF9F1239,
		...
		AVAILABLE_THEMES.add(new LucentTheme("Emerald Mist",
				0xE60B120E, 0xE6070B08, 0xFF10B981, 0xFFFFFFFF, 0xFF6EE7B7, 0xFF047857,
		...
		AVAILABLE_THEMES.add(new LucentTheme("Amethyst Eclipse",
				0xE60F0A1A, 0xE6140D24, 0xFFA855F7, 0xFFFFFFFF, 0xFFC084FC, 0xFF7E22CE,
