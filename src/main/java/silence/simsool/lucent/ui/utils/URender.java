...
public class URender {
	...
	public static void drawPlayerWithRotation(GuiGraphicsExtractor graphics, int x1, int y1, int x2, int y2, int scale, float yaw, float pitch, LivingEntity entity) {
		...
		graphics.entity(state, (float) scale, offset, q1, q2, x1, y1, x2, y2);
	}
